...
//        ,LEVEL( "music/level.ogg" )
    ...
    public void play(GameMusic music)
    {
        ...
        // do some logging
        Gdx.app.log( LOG_TAG, "Playing music: " + music.name() );
    ...
    public void stop()
    {
        if( musicBeingPlayed != null ) {
            Gdx.app.log( LOG_TAG, "Stopping current music" );
    ...
    {
        Gdx.app.log( LOG_TAG, "Adjusting music volume to: " + volume );
    ...
    public void dispose()
    {
        Gdx.app.log( LOG_TAG, "Disposing music manager" );
        stop();
    }
